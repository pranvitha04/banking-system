	...
	<div class="container">
        ...
        <select name="to" class="form-control" required>
            <option value="" disabled selected>Choose account</option>
                            <option class="table" value="2654" >
                
                    Aman (Balance: 
                    70001 ) 
               
                </option>
                            <option class="table" value="3624" >
                
                    Gaurav (Balance: 
                    11118 ) 
               
                </option>
                            <option class="table" value="4542" >
                
                    Arjun (Balance: 
                    65352 ) 
               
                </option>
                            <option class="table" value="5345" >
                
                    Saneet (Balance: 
                    1687 ) 
               
                </option>
                            <option class="table" value="5465" >
                
                    Arka (Balance: 
                    48500 ) 
               
                </option>
                            <option class="table" value="6554" >
                
                    Niky (Balance: 
                    52825 ) 
               
                </option>
                            <option class="table" value="7875" >
                
                    Siddhu (Balance: 
                    51888 ) 
               
                </option>
                            <option class="table" value="8877" >
                
                    Suvam (Balance: 
                    54000 ) 
               
                </option>
                            <option class="table" value="9245" >
